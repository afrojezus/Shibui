...
def main():
  ...
  plistpath = scriptpath + "/resources/Shibui-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Shibui-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Shibui-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Shibui-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Shibui-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Shibui-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Shibui.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Shibui.iss",inplace=1):
